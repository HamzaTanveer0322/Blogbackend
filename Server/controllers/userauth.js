  ...
  }catch(err)
{
  res.status(500).send(
   ...
   const addcomment=async(req,res)=>{
      const {discription,username,blogid,date}=req.body;
   try {  
      const blogd=new commits({
discription,
username,
date,
blogid
...
module.exports ={login,signup,logout,upload,uploads,blogget,deleteblog,viewblog,userblog,addcomment,viewcomment
}